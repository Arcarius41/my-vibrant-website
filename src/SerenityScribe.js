...
function SerenityScribe() {
  ...
  return (
    <div className="container py-5">
      {/* Separate overlay div for content */}
      <div className="text-overlay p-4 rounded">
        ...
        <p className="lead text-center">
          ...
          designed to help users track their daily moods and journal entries.
          The project leverages several technologies to deliver a seamless user
          experience:
        </p>
